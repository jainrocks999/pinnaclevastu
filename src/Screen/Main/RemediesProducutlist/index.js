...
import {addToCart, addToCartApi, getCartDataApi} from '../../../Redux/Slice/CartSlice';
...
hitSlop={{top:10,left:10,right:10,bottom:10}}
      ...
      <ScrollView contentContainerStyle={styles.Scroll}>
        <View style={styles.searchContainer}>
          ...
          <TouchableOpacity style={styles.filterBtn}  hitSlop={{top:10,left:10,right:10,bottom:10}}>
