...
const HomeScreen = () => {
  ...
  const renderItem = ({item,index}) => {
    ...
    >
      <TouchableOpacity
        style={[styles.cardContainer, { backgroundColor: item?.color_code }]} onPress={() => handleItemClick(index)}>
        <Image
  ...
  const renderItem1 = ({item,index}) => {
    ...
    >
      <TouchableOpacity style={[styles.smallCardContainer]} onPress={() => handleItemClick(index)}>
        <Image
          source={{ uri: `${Imagepath.Path}${item?.logo}` }}
  ...
  const renderItem3 = ({ item, index }) => {
    ...
    >
      ...
      <TouchableOpacity style={[styles.cardContainer2]}  onPress={() => handlePress(index)}>
